...
urlpatterns = [
    ...
    path('emptycart/', views.emptycart, name='empty'),
    ...
    path('cart/<int:order_id>/', views.order_confirm, name='order_confirm'),

    path('cart/<int:order_id>/empty', views.order_empty, name='order_empty'),
